...
Este directorio contiene herramientas de administración y monitoreo como `autoheal`, `dozzle`, `diun`, `netdata`, `portainer`, `scrutiny` y `uptime-kuma`.
...
- Uptime Kuma queda en `http://cali-home:3003` y persiste en `${APPDATA_DIR}/uptime-kuma`.
