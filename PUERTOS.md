...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| __lab_affine | affine | `AFFINE_HOST_PORT` | 3010 | `AFFINE_CONTAINER_PORT` / 3010 | TCP | Notas/documentos/pizarra | Laboratorio, red local o proxy protegido |
...
| __lab_reactive-resume | reactive-resume | `REACTIVE_RESUME_HOST_PORT` | 3015 | `REACTIVE_RESUME_CONTAINER_PORT` / 3000 | TCP | CVs y pruebas | Laboratorio, no exponer sin proxy |
...
| __lab_vikunja | vikunja | `VIKUNJA_HOST_PORT` | 3456 | `VIKUNJA_CONTAINER_PORT` / 3456 | TCP | Tareas/proyectos | Laboratorio, red local o proxy |

## Servicios sin puerto publicado

| Stack | Servicio | Acceso esperado | Nota |
| --- | --- | --- | --- |
| __lab_affine | affine-db | Red Docker del stack | PostgreSQL con pgvector |
| __lab_affine | affine-migration | Job interno | Ejecuta migraciones antes de AFFiNE |
...
| __lab_reactive-resume | reactive-resume-create-bucket | Job interno | Crea bucket S3 local |
| __lab_reactive-resume | reactive-resume-db | Red Docker del stack | PostgreSQL interno |
